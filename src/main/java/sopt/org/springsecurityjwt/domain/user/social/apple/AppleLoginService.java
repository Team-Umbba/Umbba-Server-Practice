package sopt.org.springsecurityjwt.domain.user.social.apple;
...
public class AppleLoginService {
    ...
    public String getAppleId(String socialAccessToken) throws NoSuchAlgorithmException, InvalidKeySpecException {
