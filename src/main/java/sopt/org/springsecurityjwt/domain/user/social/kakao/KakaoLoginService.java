package sopt.org.springsecurityjwt.domain.user.social.kakao;

import lombok.RequiredArgsConstructor;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import sopt.org.springsecurityjwt.domain.user.social.kakao.feign.KakaoApiClient;
import sopt.org.springsecurityjwt.domain.user.social.kakao.feign.KakaoAuthApiClient;
import sopt.org.springsecurityjwt.domain.user.social.kakao.response.KakaoAccessTokenResponse;
import sopt.org.springsecurityjwt.domain.user.social.kakao.response.KakaoUserResponse;
